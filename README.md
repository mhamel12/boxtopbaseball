...
8. Use bp_generate_box_html.py to generate box scores from the .EBA file in HTML format, including daily standings (regular season) and playoff series results (playoffs). The process for this is documented in the 1946NewEnglandLeague folder readme and requires the use of bp_generate_schedule_files_from_csv.py for best results.
